...
```sh
mkdir -p ars-pki
docker run --rm --network none --read-only --user "$(id -u):$(id -g)" -v "$PWD/ars-pki:/out" quay.io/ptrck-sh/adblock-recovery-sink:0.2.0 pki init --hosts html-load.com,content-loader.com,js-loader.com,css-load.com,d37j8pfxu2iogi.cloudfront.net,dkyerkk91s4fa.cloudfront.net --out /out
```
